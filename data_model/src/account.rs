...
pub mod model {
    ...
    /// Identification of an [`Account`] by [`PublicKey`] as its sole `signatory`.
    /// TODO #4373 include multi-signatory use.
    /// `domain_id` is not a part of the identification but included as a reference to the parent [`Domain`](crate::domain::Domain).
    /// TODO #4373 implement request & approval of domain change.
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    ///
    /// let id: AccountId = "ed0120BDF918243253B1E731FA096194C8928DA37C4D3226F97EEBD18CF5523D758D6C@domain".parse().expect("multihash@domain should be valid format");
    /// ```
    #[derive(
        DebugCustom,
        Display,
