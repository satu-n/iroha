...
mod asset {
    ...
    #[derive(
        Clone, PartialEq, Eq, Debug, Hash, Decode, Encode, Deserialize, Serialize, IntoSchema, Filter,
    )]
    #[non_exhaustive]
    #[allow(missing_docs)]
    pub enum AssetEvent {
...
#[derive(
    Clone, PartialEq, Eq, Debug, Hash, Decode, Encode, Deserialize, Serialize, FromVariant, IntoSchema,
)]
#[allow(missing_docs)]
pub enum WorldEvent {
    Peer(peer::PeerEvent),
