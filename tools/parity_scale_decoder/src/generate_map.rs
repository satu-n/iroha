...
pub fn generate_map() -> DumpDecodedMap {
    let mut map = generate_map! {
        ...
        FilterOpt<OriginFilter<AccountId>>,
        FilterOpt<OriginFilter<AssetDefinitionId>>,
        FilterOpt<OriginFilter<AssetId>>,
        FilterOpt<OriginFilter<DomainId>>,
        FilterOpt<OriginFilter<PeerId>>,
        FilterOpt<OriginFilter<RoleId>>,
        FilterOpt<OriginFilter<TriggerId>>,
        ...
        IdBox,
        OriginFilter<AccountId>,
        OriginFilter<AssetDefinitionId>,
        OriginFilter<AssetId>,
        OriginFilter<DomainId>,
        OriginFilter<PeerId>,
        OriginFilter<RoleId>,
        OriginFilter<TriggerId>,
        IdentifiableBox,
        IfExpression,
        IfInstruction,
        Instruction,
